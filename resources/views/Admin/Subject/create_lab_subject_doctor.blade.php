                    ...
                    <div class="row mx-auto">
                        <div class="col-md-6 grid-margin stretch-card">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Add Doctors To Subject</h4>
                                    ...
                                    <form class="forms-sample" method="POST" action="{{route('admin.subject_store_lab_doctor')}}">
                                        @csrf
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select multiple class="form-control" id="exampleFormControlSelect2"
                                                aria-label="Multiple select example" name="doctorId[]">
