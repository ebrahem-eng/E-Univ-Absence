                        ...
                        <div class="card">
                            ...
                            @endif
                                ...
                                <div class="card-body">
                                    ...
                                    <h4 class="card-title">Doctor Lab Table</h4>

                                    <form action="{{route('admin.subject_create_lab_doctor')}}" method="GET">
                                        @csrf
                                        <input type="hidden" name="subject_id"  value="{{$subject_id}}"/>
                                        <button  type="submit" class="btn btn-success btn-rounded btn-fw ">Add Doctors For This Subject Lab Section</button>
                                    </form>
                                    </div>
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                @foreach ($lab_doctors_details as $doctor)
                                                    <tr>
                                                        <td>{{ $doctor->id }}</td>
                                                        <td>{{ $doctor->name }}</td>
                                                        <td>{{ $doctor->email }}</td>
