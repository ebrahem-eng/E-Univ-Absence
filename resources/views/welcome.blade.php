...
<head>
    ...
    <!-- Favicon-->
    <link rel="shortcut icon" href="{{ asset('Welcome-assets/img/fav.png') }}">
    <!-- Author Meta -->
    ...
    <!--
        CSS
        ============================================= -->
    <link rel="stylesheet" href="Welcome-assets/css/linearicons.css">
    <link rel="stylesheet" href="Welcome-assets/css/font-awesome.min.css">
    <link rel="stylesheet" href="Welcome-assets/css/bootstrap.css">
    <link rel="stylesheet" href="Welcome-assets/css/magnific-popup.css">
    <link rel="stylesheet" href="Welcome-assets/css/nice-select.css">
    <link rel="stylesheet" href="Welcome-assets/css/animate.min.css">
    <link rel="stylesheet" href="Welcome-assets/css/owl.carousel.css">
    <link rel="stylesheet" href="Welcome-assets/css/jquery-ui.css">
...
<body>
    <header id="header" id="home">
        ...
        <div class="container main-menu">
            <div class="row align-items-center justify-content-between d-flex">
                <div id="logo">
                    <a href="index.html"><img src="Welcome-assets/img/logo.png" alt="" title="" /></a>
                </div>
                ...
                <div class="active-popular-carusel">
                    <div class="single-popular-carusel">
                        <div class="thumb-wrap relative">
                            <div class="thumb relative">
                                <div class="overlay overlay-bg"></div>
                                <img class="img-fluid" src="Welcome-assets/img/p1.jpg" alt="">
                            </div>
                    ...
                    <div class="single-popular-carusel">
                        <div class="thumb-wrap relative">
                            <div class="thumb relative">
                                <div class="overlay overlay-bg"></div>
                                <img class="img-fluid" src="Welcome-assets/img/p2.jpg" alt="">
                            </div>
                            <div class="meta d-flex justify-content-between">
                                <p><span class="lnr lnr-users"></span> 355 <span class="lnr lnr-bubble"></span>35</p>
                                <h4>$150</h4>
                    ...
                    <div class="single-popular-carusel">
                        <div class="thumb-wrap relative">
                            <div class="thumb relative">
                                <div class="overlay overlay-bg"></div>
                                <img class="img-fluid" src="Welcome-assets/img/p3.jpg" alt="">
                            </div>
                            <div class="meta d-flex justify-content-between">
                                <p><span class="lnr lnr-users"></span> 355 <span class="lnr lnr-bubble"></span>35</p>
                                <h4>$150</h4>
                    ...
                    <div class="single-popular-carusel">
                        <div class="thumb-wrap relative">
                            <div class="thumb relative">
                                <div class="overlay overlay-bg"></div>
                                <img class="img-fluid" src="Welcome-assets/img/p4.jpg" alt="">
                            </div>
                            <div class="meta d-flex justify-content-between">
                                <p><span class="lnr lnr-users"></span> 355 <span class="lnr lnr-bubble"></span>35</p>
                                <h4>$150</h4>
                ...
                <div class="active-upcoming-event-carusel">
                    <div class="single-carusel row align-items-center">
                        <div class="col-12 col-md-6 thumb">
                            <img class="img-fluid" src="Welcome-assets/img/e1.jpg" alt="">
                        </div>
                    ...
                    <div class="single-carusel row align-items-center">
                        <div class="col-12 col-md-6 thumb">
                            <img class="img-fluid" src="Welcome-assets/img/e2.jpg" alt="">
                        </div>
                        <div class="detials col-12 col-md-6">
                            <p>25th February, 2018</p>
                            <a href="#">
        ...
        <div class="container">
            <div class="row">
                <div class="active-review-carusel">
                    ...
                    <div class="single-review item">
                        <img src="Welcome-assets/img/r1.png" alt="">
                        <div class="title justify-content-start d-flex">
                            <a href="#">
                                <h4>Fannie Rowe</h4>
                            </a>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 single-blog">
                    <div class="thumb">
                        <img class="img-fluid" src="Welcome-assets/img/b1.jpg" alt="">
                    </div>
                ...
                <div class="col-lg-3 col-md-6 single-blog">
                    <div class="thumb">
                        <img class="img-fluid" src="Welcome-assets/img/b2.jpg" alt="">
                    </div>
                    <p class="meta">25 April, 2018 | By <a href="#">Mark Wiens</a></p>
                    <a href="blog-single.html">
                ...
                <div class="col-lg-3 col-md-6 single-blog">
                    <div class="thumb">
                        <img class="img-fluid" src="Welcome-assets/img/b3.jpg" alt="">
                    </div>
                    <p class="meta">25 April, 2018 | By <a href="#">Mark Wiens</a></p>
                    <a href="blog-single.html">
                ...
                <div class="col-lg-3 col-md-6 single-blog">
                    <div class="thumb">
                        <img class="img-fluid" src="Welcome-assets/img/b4.jpg" alt="">
                    </div>
                    <p class="meta">25 April, 2018 | By <a href="#">Mark Wiens</a></p>
                    <a href="blog-single.html">
    ...
    <script src="Welcome-assets/js/vendor/jquery-2.2.4.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.9/umd/popper.min.js"
        integrity="sha384-ApNbgh9B+Y1QKtv3Rn7W3mgPxhU9K/ScQsAP7hUibX39j7fakFPskvXusvfa0b4Q" crossorigin="anonymous">
    </script>
    <script src="Welcome-assets/js/vendor/bootstrap.min.js"></script>
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBhOdIF3Y9382fqJYt5I_sswSrEw5eihAA"></script>
    <script src="Welcome-assets/js/easing.min.js"></script>
    <script src="Welcome-assets/js/hoverIntent.js"></script>
    <script src="Welcome-assets/js/superfish.min.js"></script>
    <script src="Welcome-assets/js/jquery.ajaxchimp.min.js"></script>
    <script src="Welcome-assets/js/jquery.magnific-popup.min.js"></script>
    <script src="Welcome-assets/js/jquery.tabs.min.js"></script>
    <script src="Welcome-assets/js/jquery.nice-select.min.js"></script>
    <script src="Welcome-assets/js/owl.carousel.min.js"></script>
    <script src="Welcome-assets/js/mail-script.js"></script>
