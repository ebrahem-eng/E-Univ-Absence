                                                                    ...
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu"
                                                                            ...
                                                                            <h6 class="dropdown-header">Action</h6>
                                                                                ...
                                                                                <form action="{{route('employe.subject.choose.section' , $subject->id)}}" method="GET">
                                                                                    @csrf
                                                                                    
                                                                                    <button class="dropdown-item"
                                                                                    >Student</button>
                                                                                </form>
                                                                                    <form action="{{route('employe.subject.absence' , $subject->id)}}" method="GET">
                                                                                        @csrf
                                                                                        <button class="dropdown-item"
                                                                                        >Absence</button>
                                                                                    </form>
                                                                                    <form action="{{route('employe.subject.deprivations' , $subject->id)}}" method="GET">
                                                                                        @csrf
                                                                                        <button class="dropdown-item"
                                                                                        >Deprivations</button>
                                                                                    </form>
