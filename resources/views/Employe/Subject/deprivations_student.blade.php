                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="media">
                                                <img src="{{ asset('assets/images/student.png') }}" alt=""
                                                    ...
                                                    class="img-fluid d-flex align-self-start mr-3 rounded-circle img-thumbnail">
                                                <div class="media-body">
                                                    ...
                                                    <br>
                                                    <h4 class="card-title">Number of Absences:</h4>
                                                    <h5>{{ $absences->where('student_id', $student->id)->first()->num_absences + $delays->where('student_id', $student->id)->first()->num_delays }}
                                                    </h5>
                                                </div>
                                            </div>
                                        </div>
